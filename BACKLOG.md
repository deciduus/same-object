...
| B7 | `vault/gaps/G17-overconfident-uncertainties.md` | State screening 279 → 6 with DOIs; fix Bailey *Not Normal* = R. Soc. Open Sci. 4:160600 (2017) | Six enumerable | M |
...
| D25 | `vault/triage.base`, `_lint.py` | Add `exit:` (prediction/computation/experiment/specification/none-yet), `extends-to:` (astrobiology/ecology/circularity/conservation/sustainability/none), `next-step-cost:` fields; populate all gaps and questions | Bases view sorts by expected value | M |
