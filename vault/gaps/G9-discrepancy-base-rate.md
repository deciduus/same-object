...
**The base rate has never been computed.** Every query aimed at *how often did such
disagreements resolve to systematics versus new physics* returns zero. The dark-uncertainty
literature **inflates error bars** rather than asking historically what the discrepancies turned
out to be.
