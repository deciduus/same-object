...
# SOURCE EXTRACT — ODNI Preliminary Assessment: Unidentified Aerial Phenomena (25 June 2021)

> **Title:** Preliminary Assessment: Unidentified Aerial Phenomena
> **Official source:** Office of the Director of National Intelligence (ODNI), for the UAP Task Force
> **URL:** https://archive.dni.gov/files/ODNI/documents/assessments/Prelimary-Assessment-UAP-20210625.pdf
> **Retrieved via:** archive.dni.gov 403'd this session (Akamai edge block); fetched the identical PDF from the Internet Archive Wayback Machine mirror (`https://web.archive.org/web/2id_/https://archive.dni.gov/.../Prelimary-Assessment-UAP-20210625.pdf`), 385,812 bytes, `%PDF-1.6`.
> **Date fetched:** 2026-09-03
> **Extraction method:** `pdftotext -layout` (Poppler, via Git for Windows). **Text is VERBATIM** from the primary PDF (machine-extracted, layout-preserving; page-number/header artifacts left in place).
> **Tier:** DOCUMENTED — primary first-party document. Maps to disclosure-ledger row 3.
